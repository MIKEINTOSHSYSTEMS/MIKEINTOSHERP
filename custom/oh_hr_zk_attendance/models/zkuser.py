...
def zksetuser(self, uid, userid, name, password, role):
    ...
    command_string = pack('sxs8s28ss7sx8s16s', chr(uid), chr(role), password,
                          name, chr(1), '', userid, '')
    chksum = 0
    ...
    try:
        ...
        if len(self.userdata) > 0:
            ...
            while len(userdata) > 72:
                ...
                uid, role, password, name, userid = unpack('2s2s8s28sx31s',
                                                           userdata.ljust(72)[
                                                           :72])
                ...
                users[uid] = (
                userid, name, int(role.encode("hex"), 16), password)
